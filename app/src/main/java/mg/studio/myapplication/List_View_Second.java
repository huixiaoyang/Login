...
public class List_View_Second extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter(this, R.layout.list_view_item_layout, R.id.item_text, arrayDemo);
