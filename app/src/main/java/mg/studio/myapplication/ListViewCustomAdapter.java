...
public class ListViewCustomAdapter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        ListViewStudentsArrayAdapter studentArrayAdapter =
                new ListViewStudentsArrayAdapter(
                        getBaseContext(), // Current context
                        R.layout.list_view_custom_adapter_item_layout, // the layout for each item in the list
    ...
    private void generateDummyContent() {
        ...
        for (String element : nameDummy) {
            ...
            studentsList.add(new ListViewStudents(studentName, Integer.valueOf(studentId)));
